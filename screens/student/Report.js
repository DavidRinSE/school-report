...
const Report = props => {
    ...
    return (
        <ScrollView>
            ...
            <View style={{width: 120, display: "flex", marginTop: 30, marginBottom: 30, alignSelf: "center"}}>


                <Button
                    title="Report"
                    color="purple"
                    onPress={() => navigation.navigate('ReportSecond', {inputValue, buttonState, inputArray})}
                />
            </View>
        </ScrollView>
    );
